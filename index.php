...
// if($conn==true)
// {
// $cmd="select * from addnews";
// $x=mysqli_query($conn,$cmd);
// if(mysqli_num_rows($x))
// {
// while($row=mysqli_fetch_assoc($x))
// {
// echo "<div class='event-wrap d-flex flex-wrap justify-content-between'><figure class='m-0'><img src='news/".$row["pics"]."' height='100px'></figure><div class='event-content-wrap'><header class='entry-header d-flex flex-wrap align-items-center'><h3 class='entry-title w-100 m-0'><a href='#'>".$row["title"]."</a></h3><div class='posted-date'><a href='#'>".$row["ndt"]."</a></div><!-- .posted-date --><div class='cats-links'><a href='#'>Lucknow</a></div><!-- </header><!-- .entry-header --><div class='entry-content'><p class='m-0'>".$row["descr"]."</p></div><a href='#'>Read More</a></div><!-- .entry-footer --></div><!-- .event-content-wrap -->";
// }
// }
// else
// {
// echo "No Upadating news are available";
// }
// }
// ?>
                     </div>  
